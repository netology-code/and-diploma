...
У вас есть возможность выбрать свою тему для создания мобильного приложения. При разработке диплома на свою тему опирайтесь на следующие требования:
...
5. Учитывайте [основные критерии проекта](https://github.com/netology-code/and-diploma/tree/FAN-40#критерии-оценки). Они должны быть выполнены.
