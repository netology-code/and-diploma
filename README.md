...
- кнопку меню в AppBar с возможностью перехода на вход в аккунт и регистрацию.
- в случае, если пользователь уже вошёл в аккаунт, в меню должна быть кнопка выхода.
...
- [x] координаты, при наличии, с возможностью перехода в приложение карт;
...
Экран содержит:
- поле ввода текста
- кнопку выбора упомянутых пользователей (диалог со списком и множественным выбором)
- кнопки выбора вложения (фото, аудио, видео)
...
- кнопки выбора вложения (фото, аудио, видео)
- кнопку выбора участников (диалог со списком пользователей)
...
7. Приложение должно использовать сервер https://netomedia.ru
