...
В проекте вам предстоит работать с сервером. API, которое предоставляет сервер, с примерами вызовов описано на странице [swagger](https://94.228.125.136/swagger-ui/index.html).
...
Стена представляет собой список постов, написанный одним автором. Внешний вид аналогичен карточкам из стартового экрана. Для получения стены используйте [api](https://94.228.125.136/swagger-ui/index.html#/Wall).
...
Для получения списка работ воспользуйтесь [запросом](https://94.228.125.136/swagger-ui/index.html#/Jobs/getAll).
...
7. Приложение должно использовать сервер https://94.228.125.136/.
