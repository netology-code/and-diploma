...
3.	История поставок. История с информацией по выполненным доставкам: откуда > куда, время в дороге, название контрагента, место загрузки, место разгрузки (данные доступны по API ключу).  
4.	Связаться с разработчиками. Написать сообщение разработчику, позвонить разработчику. 
5.	Мой профиль. Информация о водителе: ФИО, колонный, номер телефона водителя, номер телефона колонного, номер телефона логиста (данные доступны по API ключу).   
